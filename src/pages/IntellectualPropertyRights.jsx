...
import startImage4 from "../assets/Intellectual_Property_image.jpg";
import ServiceLayout from "../components/ServiceLayout";
import { TbCircleDashedCheck } from "react-icons/tb";
import { RiContactsLine } from "react-icons/ri";

const IntellectualpropertyrightsTitle = [
  { title: "Copyright", desc: "Secure copyright for your work." },
  { title: "Trademark", desc: "Register your trademark." },
  {
    title: "IP Search",
    desc: "Conduct an intellectual property search.",
  },
  {
    title: "IP Audit",
    desc: "Perform an intellectual property audit.",
  },
  {
    title: "Identification & Acquisition",
    desc: "Identify and acquire IP.",
  },
  {
    title: "IP Licensing & Assignment",
    desc: "License and assign intellectual property.",
  },
  {
    title: "Advisory on Patents",
    desc: "Get advice on patents.",
  },
];
        ...
        <div className="mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center py-10">
          ...
          <div>
            <h1 className="text-5xl font-light text-gray-800 animate-fadeInLeft mt-2">
              ...
              {/* Line 2 */}
              <div className="mt-4">
                <span className="">with Comprehensive</span>
              </div>

              {/* Line 3 */}
              <div className="mt-4">IP Services</div>
            </h1>
          ...
          <div className="w-full">
            <img
              src={startImage4}
              alt="Intellectual Property rights image"
