...
import startImage8 from "../assets/Tax_strategy_image.jpg";
...
const TaxandgstcomplianceTitle = [
  ...
  { title: "TDS Returns", desc: "File TDS returns." },
  {
    title: "GST Audits & Returns",
    desc: "Conduct GST audits and file returns.",
  },
  { title: "Advance Tax", desc: "Manage advance tax payments." },
  { title: "Property Tax", desc: "Handle property tax matters." },
  {
        ...
        <div className="mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center py-10">
          ...
          <div>
            <h1 className="text-5xl font-light text-gray-800 animate-fadeInLeft mt-2">
              ...
              {/* Line 3 */}
              <div className="mt-4">Consultancy</div>
            </h1>

            <p className="mt-6 text-gray-600 text-2xl animate-fadeInBottom">
              Navigate the complexities of tax regulations with confidence. OS
              Consulting Pvt. Ltd. offers specialized tax consultancy services
              tailored to maximize savings and ensure compliance for your
              business.
            </p>
