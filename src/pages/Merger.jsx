...
import startImage18 from "../assets/Merger_Amalgamation_&_CrossBorder_Services_image.jpeg";
...
const MergerTitle = [
  {
    title: "FDI & ODI Structuring and Execution",
    desc: "Structure and execute FDI & ODI.",
  },
  {
    title: "Setting Up Indian Companies Overseas",
    desc: "Establish Indian companies abroad.",
  },
  {
    title: "Partnering with Compliance Partners Globally",
    desc: "Partner with global compliance firms.",
  },
  {
    title: "FDI & ODI Structuring and Execution",
    desc: "Ensure compliance with forex regulations.",
  },
  {
    title: "Immigration and Tax Advisory",
    desc: "Provide immigration and tax advice.",
  },
];
        ...
        <div className="mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center py-10">
          ...
          <div>
            ...
            <p className="mt-6 text-gray-600 text-2xl animate-fadeInBottom">
              Facilitating your business growth with expert services in mergers,
              amalgamations, and cross-border transactions. We ensure smooth
              transitions and compliance with international regulations for your
