...
import startImage16 from "../assets/Administration_image.png";
...
const GeneraladministrationTitle = [
  ...
  },
  {
    ...
    desc: "Create employee handbooks.",
  },
  {
    title: "Formulation of Policies",
    desc: "Develop company policies.",
  },
  {
    title: "Process Flow",
    desc: "Establish efficient process flows.",
  },
  {
    title: "Structuring Hierarchy",
    desc: "Structure organizational hierarchy.",
  },
  {
    title: "Internal Control Mechanisms",
    desc: "Implement internal control mechanisms.",
  },
  { title: "HR Matters", desc: "Handle HR-related matters." },
  {
    title: "Workforce Modulation",
    desc: "Modulate workforce as needed.",
  },
];
        ...
        <div className="mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center py-10">
          ...
          <div>
            ...
            <p className="mt-6 text-gray-600 text-2xl animate-fadeInBottom">
              From policy formulation to workforce modulation, we provide
              tailored solutions to enhance your organizational efficiency and
              internal controls.
            </p>
          ...
          <div className="w-full">
            <img
              src={startImage16}
              alt="General administration image"
