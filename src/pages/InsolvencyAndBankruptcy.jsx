  ...
  return (
    ...
    <div>
      <div className="bg-blue-200 pt-14 mt-4 mb-4 animate-fadeIn">
        {/* --- HERO SECTION --- */}
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center py-10">
          {/* LEFT CONTENT */}
          <div>
            ...
            <p className="mt-6 text-gray-600 text-2xl animate-fadeInBottom">
              ...
              companies and creditors, ensuring effective resolution of
          ...
          <div className="w-full">
            <img
              src={startImage19}
              alt="Insolvency and Bankruptcy services image"
