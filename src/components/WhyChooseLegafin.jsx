...
const WhyChooseLegafin = () => {
  ...
  return (
    <div ref={ref} className="w-full bg-white py-16 px-4 sm:px-8">
      ...
      <div className="w-full mx-auto text-center mb-4 mt-2 animate-fadeInBottom">
      ...
      <div  className="text-green-800/60 max-w-2xl mx-auto text-center mb-4 animate-fadeInBottom">
        <p>Discover the reasons businesses trust us to help them grow.</p>
      </div>

      <div className="w-full mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 px-6">
        {reasons.map((reason, index) => (
          <motion.div
            ...
            className="group p-6 rounded-xl bg-white border border-gray-100/40 shadow-xl hover:bg-gradient-to-br from-[blue-200 via-green-50 to-blue-300]/90 hover:border-2 hover:border-blue-400 transition-all duration-300 shadow-sm hover:shadow-lg text-center min-h-[220px] max-w-[500px]"
          >
